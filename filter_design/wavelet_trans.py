...
if __name__ == '__main__':
    ...
    ldct_sino = np.load('../simulation_angular/angular_180/test_transverse_sinoLD.npy', allow_pickle=True)
    ndct_sino = np.load('../simulation_angular/angular_180/test_transverse_sinoHD.npy', allow_pickle=True)
